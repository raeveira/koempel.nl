...
Frank Booth` },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "D'r Joep en het Parkstadgevoel", content: "Content for D'r Joep en het Parkstadgevoel..." },
      { title: "Best of the rest!", content: "Content for Best of the rest!..." },
      { title: "Gadverdegadverdamme", content: "Content for Gadverdegadverdamme..." },
      { title: "Het Zjwatse Loach (1)", content: "Content for Het Zjwatse Loach (1)..." },
      { title: "Het Zjwatse Loach (2)", content: "Content for Het Zjwatse Loach (2)..." },
      { title: "Het Zjwatse Loach (3)", content: "Content for Het Zjwatse Loach (3)..." },
      { title: "De Derby", content: "Content for De Derby..." },
      { title: "Roda On-line", content: "Content for Roda On-line..." },
      { title: "Forza Garba", content: "Content for Forza Garba..." },
      { title: "Koempelsjeng in Pierenland", content: "Content for Koempelsjeng in Pierenland..." },
      { title: "Chaos AD (1)", content: "Content for Chaos AD (1)..." },
      { title: "Chaos AD (2)", content: "Content for Chaos AD (2)..." },
      { title: "Chaos AD (3)", content: "Content for Chaos AD (3)..." },
      { title: "Chaos AD (4)", content: "Content for Chaos AD (4)..." },
      { title: "Chaos AD (5)", content: "Content for Chaos AD (5)..." },
      { title: "Chaos AD (6)", content: "Content for Chaos AD (6)..." },
      { title: "Chaos AD (7)", content: "Content for Chaos AD (7)..." },
      { title: "De Derby", content: "Content for De Derby..." },
      { title: "Grijze Mario", content: "Content for Grijze Mario..." },
      { title: "Maastrichtse Clubcard", content: "Content for Maastrichtse Clubcard..." },
    ]
  },
  {
    name: "Just for Pleasure",
    items: [
      { title: "Special Fifa 2001", content: "Content for Special Fifa 2001..." },
      { title: "90 jaren Roda JC (CD-Rom)", content: "Content for 90 jaren Roda JC (CD-Rom)..." },
      { title: "Winamp Skin Roda JC", content: "Content for Winamp Skin Roda JC..." },
      { title: "Roda Logo op Nokia", content: "Content for Roda Logo op Nokia..." },
    ]
  },
  {
    name: "Specials",
    items: [
      { title: "Bouw Parkstad Limburg Stadion", content: "Content for Bouw Parkstad Limburg Stadion..." },
      { title: "IPL", content: "Content for IPL..." },
      { title: "Special Bratislava", content: "Content for Special Bratislava..." },
      { title: "Special Zaragoza", content: "Content for Special Zaragoza..." },
      { title: "Bouwtekeningen", content: "Content for Bouwtekeningen.." },
    ]
  },
  {
    name: "Overige",
    items: [
      { title: "Roda-kalender", content: "Content for Roda-kalender..." },
    ]
  },
]
